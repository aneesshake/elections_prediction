...
```{r ageind, echo=FALSE, fig.cap="Distribution of Age in Nationscape data"}
...
```{r sex_vote,fig.cap="Which individual did the candidate vote for? 2020 on the left, 2016 on the right"}
...
Figure (@fig) indicates that a man is much more likely to vote for Trump than a woman is. This trend is also observed in the 2016 elections when Hillary Clinton, a woman, ran for office.





```{r survey_election_results}
