...
Overall, our model predicts a Trump majority. The model predicts a win in 32 states and a close call in 10 other states. However, it is important to again caution that this is still the popular vote.

## Weaknesses and next steps

One key weakness in our model is the way we present the results with regards to 
